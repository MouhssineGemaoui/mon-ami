...
class ListProfSpeakingFrench extends GetView<HomeControllerImp> {
  const ListProfSpeakingFrench({Key? key}) : super(key: key);
...
class List_prof_french extends GetView<HomeControllerImp> {
  final profModel profmodel;
  const List_prof_french({super.key, required this.profmodel});
  ...
  Widget build(BuildContext context) {
    return Container(
      child: InkWell(
          onTap: () {
            Get.defaultDialog(
              title: "Profile"  ,titleStyle:   GoogleFonts.inter(
                                            fontSize: 17,
                                            letterSpacing: 1,

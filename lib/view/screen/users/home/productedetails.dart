...
class ProducteDetails extends StatefulWidget {
  const ProducteDetails({super.key});
  @override
  State<ProducteDetails> createState() => _ProducteDetailsState();
}

class _ProducteDetailsState extends State<ProducteDetails> {
